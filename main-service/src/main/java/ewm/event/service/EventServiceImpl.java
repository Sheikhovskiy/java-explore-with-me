...
public class EventServiceImpl implements EventService {
    ...
    public Event update(AdminEventParam adminEventParam) {
        ...
        Event eventToModify = adminEventParam.getEvent();
        Long eventIdToModify = adminEventParam.getEventId();
        Long categoryId = adminEventParam.getCategory();
        ...
        System.out.println(eventToModify.getRequestModeration());
        ...
        Location location = locationRepository.save(eventToModify.getLocation());
    ...
    public List<Event> getAllByPublicParameters(PublicEventParam publicEventParam) {
        ...
        if (onlyAvailable) {
            BooleanExpression confirmedQ = qEvent.participantLimit.gt(qEvent.confirmedRequests.size());
        }
    ...
    public Event getById(PublicEventParam publicEventParam) {
        ...
        System.out.println("===== ОТПРАВКА ДАННЫХ НА STATCLIENT");
        List<StatsDto> viewStatsDtoList = statClient.getStats(statsCreateDto);
        System.out.println("VIEW " + viewStatsDtoList);
